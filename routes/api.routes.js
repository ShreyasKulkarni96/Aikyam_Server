...
//Campus routes
router.route('/campus/:campusId').get(campusCtrl.getCampus).patch(campusCtrl.updateCampus).delete(campusCtrl.deleteCampus);
...
router.route('/academic-year').post(academicYearCtrl.addAcademicYear).get(paginationFilter, academicYearCtrl.getAllAcademicYears);

// Batch Routes
router.route('/batch/:batchId').get(batchCtrl.getBatch).patch(batchCtrl.updateBatch).delete(batchCtrl.deleteBatch);
...
//Course routes
router.route('/course/:courseId').get(courseCtrl.getCourse).patch(courseCtrl.updateCourse).delete(courseCtrl.deleteCourse);
...
//Topic routes
router.route('/topic/:topicId').get(topicCtrl.getTopic).patch(topicCtrl.updateTopic).delete(topicCtrl.deleteTopic);
...
router.route('/student-details').post(studentCtrl.addStudentDetails).get(paginationFilter, studentCtrl.getAllStudents);
...
router.route('/event/:eventId').get(eventCtrl.getEventById).patch(eventCtrl.updateEvent).delete(eventCtrl.deleteEvent);
