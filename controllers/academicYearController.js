...
const addAcademicYear = asyncWrapper(async (req, res, next) => {
    ...
    // if (createdByUser !== "SUPER_ADMIN" || createdByUser !== 'ADMIN') {
    //     throw new AppError(403, 'You are unauthorized to add a Academic years');
    // }
